...
exports.addRedirectResponder = function(app, url) {
	...
	// replace middleware to process file upload with redirect
	exports.middleware = function(params) {
		...
		return function(req, res, next) {
			...
			// process redirect if redirect param exists in req.body
			if (redirectTo) {
...
exports.middleware = function() {
	return function(req, res, next) {
		// send json with text/html content-type if iframe transport is used
		if (!req.xhr) {
